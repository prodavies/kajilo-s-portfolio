    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-5">
          ...
          <form action="{{ route('contactMe') }}" method="post" role="form" class="php-email-form">
            @csrf
              <div class="form-row">
              ...
              <div class="form-group">
                <input type="text" class="form-control" name="subject" id="subject" placeholder="Subject" data-rule="minlen:6" data-msg="Please enter at least 6 chars of subject" />
                <div class="validate"></div>
              </div>
              <div class="form-group">
